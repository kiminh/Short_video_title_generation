...
from modeling_new_2 import UnilmForSeq2Seq, UnilmConfig
...
def main():
    ...
    parser.add_argument("--src_file", default='train_new.txt', type=str,
                        help="The input data file name.")
    parser.add_argument("--vid_file", default='train_new.txt', type=str,
                        help="The vid data file name.")
    ...
    parser.add_argument("--output_dir", default='output_new/', type=str,
    ...
    parser.add_argument('--logging_steps', type=int, default=1072)
    ...
    if args.do_train:
        ...
        train_dataloader = torch.utils.data.DataLoader(train_dataset, batch_size=_batch_size, sampler=train_sampler,
                                                       num_workers=args.num_workers, collate_fn=utils_seq2seq_new_2.batch_list_to_batch_tensors, pin_memory=False)
    ...
    # fine_tune_at = 199
    # for par in param_optimizer[:fine_tune_at]:
    ...
    if args.do_train:
        ...
        for i_epoch in trange(start_epoch, int(args.num_train_epochs)+1, desc="Epoch", disable=args.local_rank not in (-1, 0)):
            ...
            for step, batch in enumerate(iter_bar):
                ...
                input_ids, segment_ids, input_mask, lm_label_ids, masked_pos, masked_weights, _, vid_fea, vid_start = batch
                masked_lm_loss = model(vid_fea, vid_start, input_ids, segment_ids, input_mask, lm_label_ids,
                ...
                if (step + 1) % args.gradient_accumulation_steps == 0:
                    ...
                    if args.logging_steps > 0 and global_step % args.logging_steps == 0:
                        ...
                        l = (tr_loss - logging_loss)/args.logging_steps
                        logger.info("epoch_loss = %5.3f" , l)
