...
class BertEmbeddings(nn.Module):
    ...
    def forward(self, input_ids=None, token_type_ids=None, position_ids=None, inputs_embeds=None, vid_fea=None, vid_start=None):
        ...
        ###############################add by yyk
        if vid_fea is not None:
            for i in range(input_ids.size(0)):
                replace_start = vid_start[i]
                inputs_embeds[i][replace_start:replace_start+vid_fea.size(1)] = vid_fea[i]
